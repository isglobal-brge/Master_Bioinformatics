...
```{r checkNorm, fig.cap = "Comparison of log-ratio count intensity of samples 1 and 2 from the Pickrell dataset.", fig.align='center', echo=FALSE}
...
```{r MAall, fig.cap="MA-plot of Pickrell data on samples 1 and 3 for raw data and normalized data using CPM, RPKM, TPM, TMM and CQN methods.", echo=FALSE, fig.align='center'}
library(edgeR)
par(mfrow=c(3,2))
